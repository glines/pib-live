...
class MenuconfigTreeWidgetError(RuntimeError):
    pass

class MenuconfigTreeWidget(urwid.TreeWidget):
    ...
    def get_buttons(self):
        ...
        '''
        raise MenuconfigTreeWidgetError('Virtual function; implement in subclass.')

class MenuconfigTreeSubmenuWidget(OptionTreeWidget):
    pass
